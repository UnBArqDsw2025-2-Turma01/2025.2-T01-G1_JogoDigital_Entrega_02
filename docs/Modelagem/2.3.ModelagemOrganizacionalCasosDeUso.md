...
**Subpacotes/Classes:**
  ...
  - **Game State**: Armazena o estado atual do jogo.  
  - **Player**: Define a lógica e o estado do jogador.  
  - **Enemy**: Define a lógica e o estado dos inimigos.  
  - **Bullet**: Define a lógica e o estado das balas/projéteis.  

**Dependências:**  

  - **Game State** se relaciona com **Player**, **Enemy** e **Bullet**.
